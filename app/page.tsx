          ...
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-600 md:text-base">
                ...
                scenes. These are not random catalog items; they are real wheels chosen by people
                who actually drive hard.
              </p>
            </div>
          ...
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            ...
            <div className="order-1 space-y-4 md:order-2">
              ...
              <p className="text-sm text-slate-600 md:text-base">
                ...
                logistics provider, we offer a flexible combination of air and sea freight for every
                wheel order. Packaging and safety standards always stay at the highest level with
                absolutely no cut corners. What we optimize is the logistics structure, not the
                quality. You receive a safer and more predictable delivery with a total cost that
          ...
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-600 md:text-base">
                ...
                using factory data and industry-standard fitment tools. Our goal is straightforward:
                to spot and sort out potential issues with offset, width, and clearance before
                installation, not after the wheels arrive. If any shipping damage or scratches
                occur, our Canadian return hub handles everything locally with no cross-border
                returns involved. Once the situation is verified, we will provide compensation based
                on the level of damage or send a replacement at no additional cost.
              </p>
            </div>
